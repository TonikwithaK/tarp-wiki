...
Hold jump to auto-jump on landing. Hold forward while hopping to accelerate up to the speed cap.

Turning at speed requires strafe turning. If you hold forward and turn the mouse, you lose speed.

**Strafe turning:**
1. Release forward (keep jump held)
2. Press strafe in the direction you want to turn
...
Strafe jumping: hold forward + strafe, angle slightly into the strafe direction while hopping, switch strafe side every 4-5 hops to maintain a straight line. Builds speed incrementally.

Circle jumping: on the ground, make a quick 90-180° turn with forward + strafe (no jumping), then start hopping. Gains extra starting speed. This is the "awkward swipe" seen from experienced players before their first jump. More impactful in race/CTS mode (CPMA-like physics) than vanilla.
...
Technique for instant horizontal acceleration from a standstill.
...
Can combine ramp jumping with a Blaster jump on the same launch for extra height.

**Map examples:**

| Map | Jump |
|---|---|
| Xoylent | Ramp to Vortex platform (use right corner) |
| Xoylent | Double ramp to Crylink via pipes from Mega Health |
| Xoylent | Ramp to Mega Health (requires bunny hop speed) |
| Afterslime | Barrel to Mortar (walk speed, use barrel corners) |
| Afterslime | Fancy object to Electro gangway (shortcut) |
| Afterslime | Electro gangway to Strength room (silent jump pad alternative) |
| Afterslime | Barrel + pillar ramp to Mega Armor (walk speed recommended) |
| Stormkeep | Multiple long ramps throughout map |
| Stormkeep | Ramp to Mega Health via stairs (avoids armor shard route that telegraphs position) |
| Runningman | Floor edge to Crylink level (jump just before the wall) |
| Runningman | Double ramp at Hagar |
| Glowplant | Lamps throughout map to Strength, Mega Health, Devastator, Vortex |

## Related

- [[games/xonotic/index|Xonotic]]: overview
- [[games/xonotic/weapons|Weapons]]: Blaster details and movement applications
- [[games/xonotic/gameplay|Gameplay]]: how movement integrates with combat
